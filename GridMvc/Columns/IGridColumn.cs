...
namespace GridMvc.Columns
{
    ...
    public interface IColumn<T>
    {
        ...
        /// <summary>
        ///    Aggregate a Field on footer (SUM, AVG, MIN, MAX)
        /// </summary>
        IGridColumn<T> Aggregate(GridAggregateFunction aggregatefunction);
    }
    ...
    public interface IColumn
    {
        ...
        /// <summary>
        ///     Aggregate value. Empty if no aggregation was set
        /// </summary>
        GridAggregateFunction? AggregateValue { get; set; }

        IGridCell AggregateResult { get; set; }
        IGridCell PageAggregateResult { get; set; }
