...
namespace GridMvc.Html
{
    ...
    public class GridHtmlOptions<T> : IGridHtmlOptions<T> where T : class
    {
        ...
        public IGridHtmlOptions<T> WithAggregateOnFooter()
        {
            return WithAggregateOnFooter(true);
        }

        public IGridHtmlOptions<T> WithAggregateOnFooter(bool enable)
        {
            _source.EnableAggregateOnFooter = enable;
            return this;
        }

        public IGridHtmlOptions<T> WithAggregateOnFooterByPage()
        {
            return WithAggregateOnFooterByPage(true);
        }

        public IGridHtmlOptions<T> WithAggregateOnFooterByPage(bool enable)
        {
            _source.EnableAggregateOnFooterByPage = enable;
            return this;
        }
