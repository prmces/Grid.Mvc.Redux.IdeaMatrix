...
namespace GridMvc.Html
{
    ...
    public class HtmlGrid<T> : GridHtmlOptions<T>, IGrid where T : class
    {
        ...
        /// <summary>
        ///     Enable aggregate of footer
        /// </summary>
        bool IGrid.EnableAggregateOnFooter
        {
            get { return _source.EnableAggregateOnFooter; }
            set { _source.EnableAggregateOnFooter = value; }
        }

        /// <summary>
        ///     Enable aggregate of footer by page
        /// </summary>
        bool IGrid.EnableAggregateOnFooterByPage
        {
            get { return _source.EnableAggregateOnFooterByPage; }
            set { _source.EnableAggregateOnFooterByPage = value; }
        }
    }
}