...
namespace GridMvc.Html
{
    ...
    public interface IGridHtmlOptions<T> : IHtmlString
    {
        ...
        /// <summary>
        ///    Allow grid to show Aggregate on Footer
        /// </summary>
        IGridHtmlOptions<T> WithAggregateOnFooter();


        /// <summary>
        ///    Allow grid to show Aggregate on Footer
        /// </summary>
        IGridHtmlOptions<T> WithAggregateOnFooter(bool enable);

        /// <summary>
        ///    Allow grid to show Aggregate on Footer
        /// </summary>
        IGridHtmlOptions<T> WithAggregateOnFooterByPage();


        /// <summary>
        ///    Allow grid to show Aggregate on Footer
        /// </summary>
        IGridHtmlOptions<T> WithAggregateOnFooterByPage(bool enable);
